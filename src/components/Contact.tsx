...
export function Contact() {
  ...
  return (
    <section
      id="contact"
      className="border-t border-slate-800/70 bg-slate-950/95 py-16 md:py-20"
    >
        ...
        <div className="grid gap-10 md:grid-cols-[1.1fr,1fr] md:items-start">
          ...
          >
            ...
            <div className="space-y-3 text-xs text-slate-200 md:text-[13px]">
              ...
              <div className="flex flex-wrap gap-4 pt-2 text-[11px] text-slate-300">
                <div>
          ...
          <motion.div
            ...
            className="relative overflow-hidden rounded-3xl border border-slate-800/80 bg-slate-900/80 p-5 shadow-soft"
          >
            ...
            <form
              className="relative space-y-4 text-xs text-slate-200"
            ...
            >
              ...
              <div className="space-y-1.5">
                ...
                <textarea
                  ...
                  name="message"
                  rows={4}
                  className="w-full resize-none rounded-xl border border-slate-700/80 bg-slate-900/70 px-3 py-2 text-[12px] text-slate-100 outline-none ring-0 transition focus:border-sky-400 focus:bg-slate-900"
              ...
              <button
                type="submit"
                className="mt-1 w-full rounded-full bg-sky-400 px-4 py-2.5 text-[11px] font-semibold uppercase tracking-[0.25em] text-slate-950 shadow-soft transition hover:bg-cyan-400"
              >
                Send enquiry
              </button>

      ...
      <div className="mx-auto max-w-6xl px-4 md:px-6">
        ...
        <div className="grid gap-8 md:grid-cols-[1.5fr,1fr] md:items-center">
          <motion.div
            ...
            className="relative overflow-hidden rounded-3xl border border-slate-800/80 bg-gradient-to-br from-slate-900 via-slate-950 to-slate-950 p-5 shadow-soft"
          >
            <div className="pointer-events-none absolute inset-0">
              <div className="absolute inset-12 rounded-[36px] border border-slate-700/60" />
              <div className="absolute inset-4 rounded-[40px] border border-slate-800/50" />
            </div>

            <div className="relative">
              <div className="aspect-[16/9] rounded-[32px] bg-[radial-gradient(circle_at_20%_20%,rgba(56,189,248,0.25),transparent_45%),radial-gradient(circle_at_80%_60%,rgba(34,197,94,0.18),transparent_50%),radial-gradient(circle_at_center,rgba(15,23,42,1),rgba(15,23,42,1))]">
                <div className="relative h-full w-full">
                  <div className="absolute inset-[18%] rounded-[28px] border border-slate-700/50">
                    <div className="absolute inset-0 bg-[radial-gradient(circle_at_40%_30%,rgba(15,23,42,0),rgba(15,23,42,0.9)_55%),radial-gradient(circle_at_70%_70%,rgba(15,23,42,0),rgba(15,23,42,0.95)_55%)]" />
                    <div className="absolute inset-[12%] rounded-[24px] border border-dashed border-slate-700/60" />
          ...
          <motion.div
            ...
            viewport={{ once: true, amount: 0.4 }}
            transition={{ duration: 0.9, ease: [0.16, 1, 0.3, 1] }}
            className="space-y-4 text-xs text-slate-200 md:text-[13px]"
          >
            <p>
            ...
            <div className="space-y-3 rounded-2xl bg-slate-900/70 p-4 ring-1 ring-slate-800/80">
              <div className="flex items-center justify-between gap-4">
                ...
                <span className="rounded-full bg-slate-950 px-3 py-1 text-[10px] font-semibold uppercase tracking-[0.25em] text-sky-300">
                  Core hub
                </span>
              </div>
              <div className="flex items-center justify-between gap-4 border-t border-slate-800/80 pt-3">
                ...
                <span className="rounded-full bg-slate-950 px-3 py-1 text-[10px] font-semibold uppercase tracking-[0.25em] text-emerald-300">
                  Growth market
                </span>
              </div>
            </div>
